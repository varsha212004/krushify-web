...
const RegisterModal: React.FC<RegisterModalProps> = ({ onClose, onRegister, onSwitchToLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSuccess(true);
    onRegister({ fullName, phone, email });
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        {success ? (
          <div className="text-green-700 text-center mb-4">ನೀವು ಯಶಸ್ವಿಯಾಗಿ ಸೈನ್ ಅಪ್ ಮಾಡಿದ್ದಾರೆ!</div>
        ) : (
...
>
  ...
  >
    <path
      fill="#4285F4"
      d="M24 9.5c3.54 0 6.72 1.23 9.22 3.25l6.9-6.9C35.64 2.34 30.13 0 24 0 14.61 0 6.36 5.64 2.69 13.74l8.06 6.27C12.6 13.13 17.87 9.5 24 9.5z"
    />
    <path
      fill="#34A853"
      d="M46.1 24.5c0-1.64-.15-3.22-.43-4.75H24v9h12.5c-.54 2.9-2.17 5.36-4.62 7.03l7.19 5.59C43.98 37.13 46.1 31.23 46.1 24.5z"
    />
    <path
      fill="#FBBC05"
      d="M10.75 28.01c-.62-1.86-.98-3.84-.98-5.91s.36-4.05.98-5.91l-8.06-6.27C1.25 13.97 0 18.13 0 24s1.25 10.03 3.69 14.08l8.06-6.27z"
    />
    <path
      fill="#EA4335"
      d="M24 48c6.13 0 11.64-2.03 15.89-5.53l-7.19-5.59c-2.01 1.35-4.59 2.13-7.4 2.13-6.13 0-11.3-3.63-13.25-8.77l-8.06 6.27C6.36 42.36 14.61 48 24 48z"
    />
  </svg>
